    ...
    <?php //this div executes the nav bar with the 3 main functionalities ?>
		<div id="full" >
			<div id="nav-bar-full-width" style="height: 20%;" >
				...
				<ul  class="navbar navbar-fixed-top  bg-faded " style="width: 100%; height: 100%;"> 
					...
					<li id="nav-op" class="navbar-item" style="width: 33%;height: 100%" >
						<img  src="assets/route.png" style="height: 60%">
					...
					<li id="scan-op" class="navbar-item" style="width: 33%;height: 100%">
						<img src="assets/qr-code.png" style="height: 60%">
						<a   class="nav-link" style="width: 100%;height: 40%">Locate <br>Yourself </a>
					</li>
